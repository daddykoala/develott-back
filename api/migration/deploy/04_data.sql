-- SQLBook: Code
-- Deploy develott_sqitch:04_data to pg
...
INSERT INTO customer (firstname, lastname, password, email, charte, city, description, profil_picture, is_active, validate, username_gith, url_github, url_gitlab, url_portfolio, url_linkedin, job_id)
VALUES
...
INSERT INTO project (name, exerpt, description, start_date , end_date, url_slack_server, url_github_repo, url_github_projet, url_trello)
VALUES
